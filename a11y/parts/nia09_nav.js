...
function check_part_09(){
	...
	// E. Skiplinks
	if(!only_redactor){
		const nia09e1_nodes = document.querySelector('body > .skiplinks a[href="#main"]');
		...
		//const nia09e4_index = Array.prototype.indexOf.call(document.body.children, nia09e3_nodes);
